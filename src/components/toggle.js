AFRAME.registerComponent('gui-toggle', {
    ...
    init: function() {
        ...
        this.toggleHandleParams = {toggleHandleXStart: toggleHandleXStart, toggleHandleXEnd: toggleHandleXEnd};
        ...
        labelEntity.setAttribute('position', `${toggleBoxWidth} 0  ${data.lablelzoffset}`);// labelEntityX 0.02
    ...
    toggleChecked: function() {
        ...
        // console.log(data.onclickevent);
        if(data.onclickevent) {
            el.emit(data.onclickevent, {value: data.checked});
        }
    },

    animateChecked: function(checked) {
        var data = this.data;
        var toggleBox = this.toggleBox;
        var toggleHandle = this.toggleHandle;
        var toggleHandleParams = this.toggleHandleParams;
        ...
        if (checked) {
            ...
            toggleHandle.setAttribute('animation__positionIn', `property: position; from: ${toggleHandleParams.toggleHandleXStart} 0 0.02; to:${toggleHandleParams.toggleHandleXEnd} 0 0.02; dur:200; easing:easeInOutCubic;`);
        }else{
            ...
            toggleHandle.setAttribute('animation__positionOut', `property: position; from: ${toggleHandleParams.toggleHandleXEnd} 0 0.02; to:${toggleHandleParams.toggleHandleXStart} 0 0.02; dur:200; easing:easeInOutCubic;`);
        }
    },
});
...
AFRAME.registerPrimitive( 'a-gui-toggle', {
    ...
    mappings: {
        ...
        'opacity': 'gui-toggle.opacity',
        'onclickevent': 'gui-toggle.onclickevent',
        'lablelzoffset': 'gui-toggle.lablelzoffset'
    }
});
